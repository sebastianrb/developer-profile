jQuery(document).ready(function($) {
    ...
    function showModal() {
        ...
        modalOpenTimeline.to($modal, 0.6, {
        ...
        modalOpenTimeline.to($modalText, 0.7, {
    ...
    function hideModal() {
        ...
        modalCloseTimeline.to($modalText, 0.7, {
            className: "-=image-modal__modal-text-content--shown"
        });

        //animate in description text
        modalCloseTimeline.to(
            $modalCloseButton,
            0.7,
            {
                className: "-=image-modal__close-modal--shown"
    ...
    function nextImage(event) {
        ...
        var nextImageSrc = gridImages[selectedImageID]
            .querySelector(".section--about-me__image-grid-image")
            .getAttribute("src");
    ...
    var imageDescriptions = {
        ...
        13: "Me in Spain",
        14: "My dad, Jake, giving a talk at a conference on environmental preservation",
